...
ExternalProject_Add_Step(mpv copy-binary
    ...
    COMMAND ${CMAKE_COMMAND} -E copy ${MINGW_INSTALL_PREFIX}/bin/vulkan-1.dll       ${CMAKE_CURRENT_BINARY_DIR}/mpv-package/vulkan-1.dll
    ...
    COMMAND ${CMAKE_COMMAND} -E copy ${MINGW_INSTALL_PREFIX}/bin/vulkan-1.dll ${CMAKE_CURRENT_BINARY_DIR}/mpv-dev/vulkan-1.dll
    COMMAND ${CMAKE_COMMAND} -E copy ${MINGW_INSTALL_PREFIX}/bin/lua51.dll   ${CMAKE_CURRENT_BINARY_DIR}/mpv-dev/lua51.dll
